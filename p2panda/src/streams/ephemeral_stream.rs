...
/// Message being dissiminated to other nodes via gossip.
///
    ...
    M: Serialize + for<'a> Deserialize<'a>,
{
    ...
    pub fn verify(&self) -> Result<(), WrappedMessageError> {
        ...
        // Treat encoding error for verifying the signature as an "invalid signature" since we
        // the data came from an remote (potentially malicious) node.
