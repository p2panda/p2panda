...
mod tests {
    ...
    fn validate() {
        ...
        assert!(MessageEncoded::new("").is_ok());
    }

    #[test]
    fn decode() {
        // This is the message from `message.rs` encode and decode test
        let message_encoded = MessageEncoded::new("").unwrap();
