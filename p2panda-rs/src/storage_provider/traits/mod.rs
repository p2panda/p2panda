...
//! offered here build documents new on each query and are only intended as a
//! convenience. Efficient storage and querying of documents should be considered
//! by implementers of these traits.
mod document_store;
mod entry_store;
mod log_store;
mod models;
