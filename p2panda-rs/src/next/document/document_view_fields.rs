...
use crate::next::operation::{OperationFields, OperationId, OperationValue, VerifiedOperation};
...
mod tests {
    ...
    use crate::next::document::{DocumentViewFields, DocumentViewValue};
    use crate::next::operation::traits::{AsOperation, AsVerifiedOperation};
    use crate::next::operation::{OperationId, OperationValue, VerifiedOperation};
    use crate::next::test_utils::fixtures::{random_operation_id, verified_operation};
