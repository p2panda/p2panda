...
use crate::next::operation::{
    EncodedOperation, Operation, OperationFields, OperationId, OperationValue, VerifiedOperation,
};
...
pub fn encoded_create_string(operation: Operation) -> String {
    EncodedOperation::try_from(&operation).unwrap().to_string()
}
...
pub fn operation_encoded(
    ...
    EncodedOperation::try_from(&operation(fields, previous_operations, schema)).unwrap()
}
...
pub fn operation_encoded_invalid_relation_fields() -> EncodedOperation {
    ...
    //   }
    // }
    EncodedOperation::new(b"")
}
