...
mod tests {
    ...
    use crate::test_utils::memory_store::helpers_next::{populate_store, PopulateStoreConfig};
    ...
    #[should_panic(expected = "public key 2f8e50c2ede6d936ecc3144187ff1c273808185cfbc5ff3d3748d1ff7353fc96, log id 4, seq num 6")]
