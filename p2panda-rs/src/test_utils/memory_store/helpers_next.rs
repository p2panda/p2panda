...
use super::domain_next::{next_args, publish};
...
mod tests {
    ...
    use crate::test_utils::fixtures::{
        key_pair, operation, operation_fields, schema, update_operation, random_key_pair,
    };
    ...
    #[rstest]
    #[tokio::test]
    async fn sends_to_node(operation: Operation, schema: Schema, key_pair: KeyPair, #[from(random_key_pair)] another_key_pair: KeyPair) {
        let store = MemoryStore::default();
