...
#[case::non_default_operation(create_operation(SchemaId::new(&format!("venue_{}", DEFAULT_SCHEMA_HASH)).unwrap(), operation_fields(vec![("message", OperationValue::Text("Boo!".to_string()))])))]
