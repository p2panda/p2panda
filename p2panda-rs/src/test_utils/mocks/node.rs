...
mod tests {
    ...
    #[rstest]
    fn publishing_entries(schema: SchemaType, private_key: String) {
    ...
    #[rstest]
    fn next_entry_args_at_specific_seq_num(schema: SchemaType, private_key: String) {
        let panda = Client::new("panda".to_string(), keypair_from_private(private_key));
        let mut node = Node::new();
    ...
    #[rstest]
    fn concurrent_updates(schema: SchemaType, private_key: String) {
        let panda = Client::new("panda".to_string(), keypair_from_private(private_key));
