...
#[should_panic]
#[case::wrong_message(crate::tests::fixtures::create_message(MESSAGE_SCHEMA.into(), fields(vec![("message", "Boo!")])))]
#[should_panic]
#[case::wrong_message(crate::tests::fixtures::create_message(MESSAGE_SCHEMA.into(), fields(vec![("date", "2021-05-02T20:06:45.430Z")])))]
#[should_panic]
#[case::wrong_message(crate::tests::fixtures::create_message(MESSAGE_SCHEMA.into(), fields(vec![("message", "Hello!"), ("date", "2021-05-02T20:06:45.430Z")])))]
...
#[template]
#[rstest]
#[case::first_entry(crate::tests::fixtures::defaults::first_entry())]
#[case::entry_with_backlink(crate::tests::fixtures::defaults::entry_with_backlink())]
#[case::entry_with_backlink_and_skiplink(crate::tests::fixtures::defaults::entry_with_backlink_and_skiplink())]
fn many_entry_versions(#[case] entry: Entry, key_pair: KeyPair) {}

// This template contains various types of valid message.
#[template]
#[rstest]
#[case::create_message(crate::tests::fixtures::defaults::create_message())]
#[case::update_message(crate::tests::fixtures::defaults::update_message())]
#[case::delete_message(crate::tests::fixtures::defaults::delete_message())]
...
#[template]
#[rstest]
#[case::v0_1_0(crate::tests::fixtures::v0_1_0_fixture())]
