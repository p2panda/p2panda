...
// More specific fixtures which can be used in the same way as above but also simple as helper functions
// with no passed parameters returning a useful test value. This is needed the templates where fixtures can't be injected
// in the usual way
