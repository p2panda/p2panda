...
pub fn message(
    ...
    match message_type {
        MessageTypes::Create => TestPanda::create_message(CHESS_SCHEMA, keys, values),
...
pub fn v0_1_0_fixture() -> PandaTestFixture {
    PandaTestFixture {
        ...
        entry: TestPanda::entry(&TestPanda::create_message(CHESS_SCHEMA, vec!["name", "description"], vec!["chess", "for playing chess"]), &TestPanda::seq_num(1), None, None)
    }
}
