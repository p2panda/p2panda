...
- Use new `Operation` naming which replaces `Message` [#156](https://github.com/p2panda/p2panda/pull/156) `rs`
- Refactoring in `Schema` [#160](https://github.com/p2panda/p2panda/pull/160) `rs`
