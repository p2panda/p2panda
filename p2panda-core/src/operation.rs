...
///
/// A header holds all metadata required to cryptographically secure & authenticate the message
    ...
    E: Extensions,
{
    ...
    /// Verify that the signature contained in this `Header` is was generated by the claimed
    /// public key.
